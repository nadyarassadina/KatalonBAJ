...
WebUI.click(findTestObject('BAJit/flightSearch/add1_button'))

WebUI.setText(findTestObject('BAJit/flightSearch/departureAirportLeg2_textBox'), departureAirport2)

WebUI.setText(findTestObject('BAJit/flightSearch/destinationAirportLeg2_textBox'), destinationAirport2)
