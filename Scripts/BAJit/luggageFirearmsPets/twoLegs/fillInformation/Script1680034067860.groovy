...
WebUI.setText(findTestObject('BAJit/passengerTab/luggageFirearmsPets/leg1/luggage_textArea'), luggage1)

WebUI.setText(findTestObject('BAJit/passengerTab/luggageFirearmsPets/leg1/firearms_textArea'), firearms1)

WebUI.setText(findTestObject('BAJit/passengerTab/luggageFirearmsPets/leg1/pets_textArea'), pets1)
...
WebUI.setText(findTestObject('BAJit/passengerTab/luggageFirearmsPets/leg2/luggage_textArea'), luggage2)

WebUI.setText(findTestObject('BAJit/passengerTab/luggageFirearmsPets/leg2/firearms_textArea'), firearms2)

WebUI.setText(findTestObject('BAJit/passengerTab/luggageFirearmsPets/leg2/pets_textArea'), pets2)
